...
ARG VITE_PUBLIC_STRIPE_PRO_PRICE_ID
ARG VITE_PUBLIC_STRIPE_PREMIUM_PRICE_ID

# Set them as environment variables for the build process
ENV VITE_SUPABASE_URL=${VITE_SUPABASE_URL}
ENV VITE_SUPABASE_ANON_KEY=${VITE_SUPABASE_ANON_KEY}
ENV VITE_PUBLIC_STRIPE_PUBLISHABLE_KEY=${VITE_PUBLIC_STRIPE_PUBLISHABLE_KEY}
ENV VITE_PUBLIC_STRIPE_PRO_PRICE_ID=${VITE_PUBLIC_STRIPE_PRO_PRICE_ID}
ENV VITE_PUBLIC_STRIPE_PREMIUM_PRICE_ID=${VITE_PUBLIC_STRIPE_PREMIUM_PRICE_ID}

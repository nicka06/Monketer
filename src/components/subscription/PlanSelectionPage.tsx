...
const PlanSelectionPage: React.FC = () => {
  ...
  useEffect(() => {
    if ((isBgImageLoaded || bgImageError) && !hideLoadingCalledRef.current) {
      console.log("PlanSelectionPage: Background image loaded/errored, hiding loading screen.");
      hideLoading();
      hideLoadingCalledRef.current = true;
    }
  }, [isBgImageLoaded, bgImageError, hideLoading]);
  ...
  return (
    <div className="relative flex flex-col min-h-screen overflow-hidden">
      <img
        ...
        onLoad={() => {
          console.log("PlanSelectionPage: Background image loaded.");
          setIsBgImageLoaded(true);
        }}
        onError={() => {
          console.error("PlanSelectionPage: Error loading background image.");
          setBgImageError(true);
        }}
      />
      <div className="relative z-10 flex-grow py-12 px-4 sm:px-6 lg:px-8 bg-black bg-opacity-20">

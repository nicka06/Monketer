          ...
          <form onSubmit={handleSubmit} className="mt-6 flex max-w-md mx-auto gap-x-4">
            <div className="min-w-0 flex-auto">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="block w-full rounded-md border-0 px-3.5 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emailore-purple"
            ...
            <button
              type="submit"
              className="flex-none rounded-md bg-emailore-purple px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-emailore-purple-dark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emailore-purple relative group"
            >
              Start Creating
